                    ...
                    <div className="nav-container">
                        ...
                        <div className="nav-element" id="searchbar">
                            <div className="actual-search-bar">
                                <input type="text" placeholder="Cari Produk Yang Kamu Inginkan"/>
                                <Link to="/search">
                                <button><i className="fas fa-search"></i></button>
                                </Link>
                            </div>
                        </div>
                        <div className="nav-element" id="cart"><Link to="/cart" style={{ textDecoration: 'none', color: 'inherit' }}><i className="fas fa-shopping-cart"></i></Link></div>
