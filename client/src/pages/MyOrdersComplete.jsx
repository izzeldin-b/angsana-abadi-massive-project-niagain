...
function MyOrdersComplete() {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/get-user-orders-all-details-selesai`, { 
...
export default MyOrdersComplete